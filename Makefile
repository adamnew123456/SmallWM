...
HEADERS=src/actions.h src/clients.h src/clientmanager.h src/common.h src/configparse.h src/desktops.h src/events.h src/icons.h src/layers.h src/shared.h src/utils.h
